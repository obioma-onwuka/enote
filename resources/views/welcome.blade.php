<x-main>
    ...
    <div class="py-5 bg-white">
        <div class="px-4 my-5 text-center">
            <h1 class="display-5 fw-bold mt-4">Enote Task Manager</h1>
            <div class="col-lg-6 mx-auto">
                <p class="lead mb-4">Enote gives you everything you need to organize your tasks easily.</p>
                <div class="d-flex justify-content-sm-center">
                    <a href="#" class="btn btn-primary btn-lg mr-2" style = "background: rgb(99, 99, 186); border-radius: 37px">Register</a>
    ...
    <div class="container py-5 bg-white mb-4">
        <div class="row">
            ...
            <div class="col-lg-6 text-center">
                <p class = "lead mb-4">Enote is a unique tasks management platform that gives you everything you need to organize your tasks easily.</p>
                <p class = "lead mb-4">From task creation, task assignment to task management, the interface is collectively easy to navigate. Enote will help you achieve maximum output per day through easy task managements.</p>
            </div>
        </div>
    </div>
